...
public class ControlButton extends JButton {
	...
	private static final Function<LMCInterface, Boolean> CONDITION_PROGRAM_NOT_RUNNING_OR_NULL = (lmc) -> {
		if(lmc.getProcessor() == null) return true;
		return !lmc.getProcessor().isRunning();
	};
	private static final Function<LMCInterface, Boolean> CONDITION_PROGRAM_RUNNING_AND_NOT_NULL = (lmc) -> {
