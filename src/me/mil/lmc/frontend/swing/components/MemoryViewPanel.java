...
public final class MemoryViewPanel extends LMCSubPanel {
	...
	protected void generate() {
		...
		setBackground(StyleUtil.COLOR_MEMORY_VIEW_BACKGROUND);
		...
		new ProgramObserver(getInterface()){
			...
			public void update(Observable o, Object arg) {
				memoryUnits.forEach((id, unit) -> unit.setOpCode(((ProgramState)arg).getValue(id)));
			}
		};
	...
	private static class MemoryUnit extends LMCPanel {
		...
		protected void generate() {
			...
			panelID.setBorder(StyleUtil.BORDER_EMPTY);
			panelID.setBackground(StyleUtil.COLOR_MEMORY_UNIT_ID_BACKGROUND);
			...
			panelOpCode.setBorder(StyleUtil.BORDER_EMPTY);
			...
			labelOpCode.setForeground(StyleUtil.COLOR_MEMORY_UNIT_OPCODE_FOREGROUND);
		...
		public void playUpdateAnimation() {
			Color initColor = StyleUtil.COLOR_MEMORY_UNIT_OPCODE_FOREGROUND;
